  ...
  return (
    <div className="sidebar !py-6">
      <div className="box">
        ...
        <h3 className=" w-full !mb-3 text-[16px] font-[600] flex items-center !pr-5">Availability<Button className=" !text-[black] !w-[30px] !h-[30px] !min-w-[30px] !rounded-full !ml-auto" onClick={()=>setIsOpenAvailFilter(!isOpenAvailFilter)} >
        ...
        <div className="scroll !px-4 relative -left-[13px]">
         ...
         <FormControlLabel control={<Checkbox size="small" />} label="In Stock (11)" className='w-full'/>
        ...
        <div className="box !mt-3">
        <h3 className=" w-full !mb-3 text-[16px] font-[600] flex items-center !pr-5">Size<Button className=" !text-[black] !w-[30px] !h-[30px] !min-w-[30px] !rounded-full !ml-auto" onClick={()=>setIsOpenSizeFilter(!isOpenSizeFilter)} >
