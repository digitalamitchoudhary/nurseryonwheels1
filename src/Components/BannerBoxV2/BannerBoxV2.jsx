  ...
  return (
       ...
       <div className="bannerBoxV2 w-full h-[210px] overflow-hidden rounded-md group relative">
            <Link to={props.Link} >
                ...
                <div className={`info absolute !p-5 flex flex-col items-center justify-center top-0 ${props.info==="left"? 'left-0' : 'right-0  !pl-15' } w-[60%] h-[100%] gap-2 z-50`}>
                  <h2 className="text-[22px] font-[600]">Samsung Gear VR Camera</h2>
                  <span className="text-[1.8vh] font-[700] w-full  text-[#ff5252]"> ₹ 1,850 </span>
